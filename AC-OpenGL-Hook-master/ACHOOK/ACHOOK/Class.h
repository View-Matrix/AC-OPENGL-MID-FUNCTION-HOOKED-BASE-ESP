...
namespace AssaultCube
{
	...
	public:
		...
		char _0x0008[8];
		__int32 m_GraphicDetail; //0x0010
		__int32 m_AntiAlias; //0x0014 
	...
	public:
		...
		Player* GetPlayer(int index) const
		{
			...
			if (Mem::IsLinked(this->m_OtherPlayers))
			{
				if (Mem::IsLinked(this->m_OtherPlayers[index]))
				{
